...
var ABOUT_RESOURCES = [
      {
        ...
        "image":"//chart.googleapis.com/chart?chl=GL%202.0%7CGL%203.0%7CGL%203.1&chf=bg%2Cs%2C00000000&chd=t%3A54.3%2C38.9%2C6.8&chco=c4df9b%2C6fad0c&cht=p&chs=400x250",
        "lang":"en",
        "type":"about"
      }, 
      {
...
var DESIGN_RESOURCES = [
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Consistent navigation is an essential component of the overall user experience. Few things frustrate users more than basic navigation that behaves in inconsistent and unexpected ways. Android has introduced significant changes to the global navigation…",
...
var DISTRIBUTE_RESOURCES = [
      ...
      }, 
      {
        ...
        "image":"images/cards/distribute/users/banners.png",
        "lang":"en",
        "type":"distribute"
      }, 
      {
...
var TOOLS_RESOURCES = [
      ...
      }, 
      {
        "title":"Testing",
        "titleFriendly":"",
        "summary":"The Android framework includes an integrated testing framework that helps you test all aspects of your application and the SDK tools include tools for setting up and running test applications. Whether you are working in Android Studio or working from …",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"This document describes how to create and run tests directly from the command line. You can use the techniques described here if you are developing in an IDE other than Android Studio or if you prefer to work from the command line. This document assumes…",
...
var TRAINING_RESOURCES = [
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"The Android platform is optimized to support multiprocessor architectures. This document introduces issues that can arise when writing code for symmetric multiprocessor systems in C, C++, and the Java programming language (hereafter referred to simply…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"The Android platform offers system-level device management capabilities through the Device Administration APIs. In this lesson, you will learn how to create a security-aware application that manages access to its content by enforcing device management…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Loading a single bitmap into your user interface (UI) is straightforward, however things get more complicated if you need to load a larger set of images at once. In many cases (such as with components like ListView, GridView or LruCache class is particularly…",
...
var DISTRIBUTE_BY_TAG = {
    "landing":[1], 
    "quality":[1,7,24,31,34,35,36,38], 
    "wear":[7,38], 
    "wearables":[7], 
    "":[9,11], 
    "engagement":[10,16,20,21], 
    "intents":[10], 
    "gcm":[12], 
    "beta":[13], 
    "alpha":[13], 
    "releasechannels":[13], 
    "google":[14,29,37,49,52,54], 
    "identity":[14,49,52,54], 
    "signin":[14,49,54], 
    "analytics":[15,58,59,60,61,62,63], 
    "userbehavior":[15,58,59,60,61,62,63], 
    "games":[18,30,41], 
    "gamesservices":[18], 
    "playgames":[18], 
    "updates":[19], 
    "gpfe":[23], 
    "googleplay":[23,33,37,40,41,42,47,69], 
    "distribution":[23,33], 
    "edu":[23], 
    "education":[24,25], 
    "guidelines":[24,34,35], 
    "visibility":[26], 
    "growth":[26,45,47,53,56], 
    "distributing":[26], 
    "enterprise":[27], 
    "emm":[27], 
    "business":[27], 
...
var GUIDE_BY_TAG = {
    ...
    "listview":[60], 
    "preference":[69], 
    "preferenceactivity":[69], 
    "preferencefragment":[69], 
    "clipdata":[70,130], 
    "dragevent":[70], 
    "onlongclicklistener":[70], 
    "button":[71], 
    "imagebutton":[71], 
    "adapterview":[72], 
    "spinneradapter":[72], 
    "edittext":[73], 
    "autocompletetextview":[73], 
    "radiobutton":[75], 
    "radiogroup":[75], 
    "switch":[76], 
    "togglebutton":[76], 
    ...
    "timepicker":[77], 
    "wireless":[82,83,88], 
    "bluetoothadapter":[82,83], 
    "bluetoothdevice":[82,83], 
    ...
    "searchrecentsuggestionsprovider":[106,109], 
    "searchview":[107], 
    "searchrecentsuggestions":[109], 
    "home":[110], 
    "appwidgetprovider":[110], 
    "appwidgethost":[111], 
    "homescreen":[111], 
    "launcher":[111], 
    "localizing":[119], 
    ...
    "l10n":[119], 
    "input":[129,130], 
    "spellcheckerservice":[129], 
    "clipboardmanager":[130], 
    "ime":[131], 
    "keyboard":[131], 
    "inputmethodservice":[131], 
    "mediaplayer":[133], 
    "soundpool":[133], 
    "audiomanager":[133], 
    "audio":[134,177], 
    ...
    "miracast":[138], 
    "mediarecorder":[139], 
    "mediarouteprovider":[140], 
    "mediacontrolintent":[140], 
    "permissions":[141,142,147,169], 
    "normal":[141], 
    "filtering":[147], 
    "features":[147], 
    "googleplayfilters":[147], 
    "apilevels":[157], 
    "sdkversion":[157], 
    "minsdkversion":[157], 
    "targetsdkversion":[157], 
    "maxsdkversion":[157], 
    "uses-permission-sdk-23":[169], 
    "location":[171], 
    "sensors":[171], 
    "sensorevent":[174,175], 
    "orientation":[174], 
...
var TOOLS_BY_TAG = {
    ...
    "project":[140], 
    "mipmap":[140], 
    "android":[144,145,146,147,148,149,150,151,152,153,154,155,156,157,158], 
    "develop":[144], 
    "performance":[144,145,146,147,148,149,150,151,152,153,154,155,156,157,158], 
    "profiling":[144,145,146,147,148,149,150,151,152,153,154,155,156,157,158], 
    "tools":[144,145,146,147,148,149,150,151,152,153,154,155,156,157,158], 
    "gather":[144]
};

var TRAINING_BY_TAG = {
    "sdktools":[0], 
    "intents":[1,18,19,20,21,226], 
    "ui":[2,342], 
    "emulator":[3], 
    "projectsetup":[4], 
    "activitylifecycle":[5,6,7,8,9], 
    "network":[11,105,116,199,298,313], 
    "wireless":[11,298,313], 
    "datastorage":[14,15,16,17], 
    "files":[14], 
    "sql":[14], 
    "database":[14,253], 
    "preferences":[14], 
    "fragments":[22,23,24,25,237], 
    "userinterface":[22,178], 
    "supportlibrary":[22], 
    "layouts":[26,27], 
    "resources":[26,28], 
    "screens":[26], 
    ...
    "geofence":[48], 
    "geofencing":[48], 
    "activityrecognition":[48], 
    "activitydetection":[48], 
    "gps":[48,114], 
    "permissions":[59,62,109], 
    "runtimepermissions":[61], 
    "androidm":[61,186,242], 
    "marshmallow":[61,106,186,202,242], 
    "support":[63,188,237], 
    "authentication":[69], 
    "signin":[69], 
    "wear":[70,71,72,73,74,75,76,99], 
    "notifications":[99,100,101,102,103,215,216,217,218,219,220], 
    "assistant":[106], 
    "ram":[108], 
    "lowmemory":[108], 
    ...
    "asynctask":[115], 
    "gamecontroller":[117], 
    "tv":[132,133,135,136,138,139,141,142,143,144,145,146,147,148,150,151,237], 
    "leanback":[132,135,136,140,147], 
    "search":[134,294], 
    "searchable":[134], 
    "unsupported":[137], 
    "card":[149], 
    ...
    "enterprise":[194], 
    "corporate":[194], 
    "workpolicycontroller":[196], 
    "wpc":[196], 
    "devicepolicycontroller":[196], 
    "dpc":[196], 
    "battery":[202,313], 
    "":[210], 
    ...
    "billing":[230], 
    "tablet":[237], 
    "multiplescreens":[239,293], 
    "cloud":[241,335], 
    "sync":[241], 
    "backup":[241,242], 
    "wakelock":[250], 
    "alarmmanager":[250], 
    "wakefulbroadcastreceiver":[250], 
    "searchview":[253], 
    "privacy":[257], 
    "oauth":[257], 
    "accounts":[257], 
    "testing":[261,280,281,282,284,285,286], 
    "threadpool":[267], 
    "runnable":[267], 
    "nfcadapter":[272], 
    "androidbeam":[272], 
    ...
    "bitmaps":[329], 
    "images":[329], 
    "appbar":[336,337,338,340], 
    "actionbar":[336,337,338,340], 
    "actionview":[339], 
    "actionprovider":[339], 
    "print":[347]
};
